<script lang="ts">
    ...
    const prefersReducedMotion = () => {
        if (!browser)
            throw new Error(
                "prefersReducedMotion is only available in the browser",
            );
    ...
    onMount(() => {
        ...
        try {
            ...
            // Property already registered, ignore error
        }
...
--bg: {heroBgImageSet};"
        ...
        <div class="greeting">
            ...
            <h1 class="hello" class:browser>
                ...
                <span class="names animate-casl" class:browser>
                    ...
                    {/each}
                    <span aria-hidden="true" class="animate-casl"
                        >{longestName}</span
                    >
                </span>
            </h1>
        ...
        <div class="info">
            <ul class="roles">
                ...
                {@render tag(
                    "programmer",
                    m.hero_programmer(),
                    "https://github.com/Suya1671",
                )}
                {@render tag(
                    "gamer",
                    m.hero_gamer(),
                    "https://steamcommunity.com/id/Suya1671",
                )}
            </ul>
            <ul class="contact">
                <li>
    ...
    <section>
        <p>
            Hey! I'm Suya, your probably-not-local computer nerd programming
            person. I like to make (questionably useful) apps, websites, and
            random utilities. I also am known to be a walking advertisement for
            my current favourite thing (be it a game, song, website, etc.).
        </p>
        <!-- <enhanced:img
...
<style>
    @media (prefers-color-scheme: light) {
        ...
        @property --to {
            ...
            /* secondary */
            initial-value: lch(59% 40 251deg);
            syntax: "<color>";
        }
    }
        ...
        & > :first-child {
            ...
            .greeting {
                ...
                .image-container {
                    ...
                    transition:
                        padding 600ms var(--m3-easing),
                        margin 600ms var(--m3-easing);
