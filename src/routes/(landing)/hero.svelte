...
--bg: {heroBgImageSet};"
  ...
  <section>
    <p>
      Hey! I'm Suya, your probably-not-local computer nerd programming person. I
      like to make (questionably useful) apps, websites, and random utilities. I
      also am known to be a walking advertisement for my current favourite thing
      (be it a game, song, website, etc.).
    </p>
    <!-- <enhanced:img
